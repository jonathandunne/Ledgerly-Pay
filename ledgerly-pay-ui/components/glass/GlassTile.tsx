...
export function GlassTile({
  ...
  return (
    <div
      className={`glass-tile group relative overflow-hidden rounded-2xl border border-white/20 bg-gradient-to-br from-sky-200/30 via-white/10 to-white/5 p-6 shadow-[0_20px_60px_-40px_rgba(15,23,42,0.6)] backdrop-blur-2xl dark:border-white/10 dark:bg-black/40 dark:from-white/10 dark:via-white/5 dark:to-black/60 dark:shadow-[0_30px_90px_-50px_rgba(0,0,0,0.9)] ${className}`}
    >
